    ...
    <div className={classnames(['Menu__panel', isMenuOpen && 'Menu__panel--open'])}>
      <div className="Section">
        <ol>
          ...
          <li><Link to="https://www.linkedin.com/in/barbaramarche/" onClick={handleCloseMenu} target="_blank">Linkedin</Link></li>
          <li><Link to="https://www.behance.net/barbara-marche" onClick={handleCloseMenu} target="_blank">Behance</Link></li>
        </ol>
      </div>
    </div>
